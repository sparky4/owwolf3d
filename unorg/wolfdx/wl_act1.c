...
void PushWall (int checkx, int checky, int dir)
{
        ...
        case di_north:
                ...
                actorat[checkx][checky-1] = (objtype *) (tilemap[checkx][checky-1] = oldtile);
                break;
        ...
        case di_east:
                ...
                actorat[checkx+1][checky] = (objtype *) (tilemap[checkx+1][checky] = oldtile);
                break;
                ...
                *(mapsegs[0]+(pwally<<mapshift)+pwallx) = player->areanumber+AREATILE;
                ...
                else
                {
                        ...
                        case di_north:
                                ...
                                actorat[pwallx][pwally-1] = (objtype *) (tilemap[pwallx][pwally-1] = oldtile);
                                break;
                        ...
                        case di_east:
                                ...
                                actorat[pwallx+1][pwally] = (objtype *) (tilemap[pwallx+1][pwally] = oldtile);
                                break;
